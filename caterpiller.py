...
text_turtle.write('Press SPACE to start',align='center',font=("Verdana",20,'bold'))
...
def game_over():
    ...
    t.hideturtle()
    t.color('blue')
    t.write('GAME OVER!',align='center', font=("Verdana",30,'bold'))
...
def display_score(current_score):
    ...
    score_turtle.write(str(current_score), align='right', font=("Verdana",50,'bold'))
